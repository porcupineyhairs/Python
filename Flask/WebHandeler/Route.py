...
def Route(app=None, hostInfo=None):
	if app is None:
		...
		def Test_W_0():
			__json = [
				{"BrandName": "ACES", "Modul": "91906-0227P", "Quantity": "3057", "Datecode": "W2Y", "Remark": "stock"},
		...
		@app.route('/GongShi/201909')
		def GongShi():
			Gongshi.gongshi('201909')
			return ('<title>税务收集工单工时</title>' + '<h1>您的IP地址为：' + request.remote_addr + '</h1>' + '<h1>税务收集工单工时201909已收集</h1>')
