...
from urls.api.dingtalk.program.comforterp import api_dingtalk_program_comforterp_blueprint
...
api_dingtalk_program_buleprint.register_blueprint(api_dingtalk_program_comforterp_blueprint, url_prefix='/comforterp')
