...
class ChartTestView(View):
	def get(self, request):
		return render(request, 'a_test_chart.html', locals())
...
class IcoTestView(View):
	def get(self, request):
		return render(request, 'a_test_ico.html', locals())


class UiTestView(View):
	def get(self, request):
		return render(request, 'a_test_ui.html', locals())


class FormTestView(View):
	def get(self, request):
		return render(request, 'a_test_form.html', locals())
