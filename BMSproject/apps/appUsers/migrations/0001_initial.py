    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('男', '男'), ('女', '女'), ('未填写', '未填写')], default='未填写', max_length=5, verbose_name='性别')),
                ('adress', models.CharField(default='', max_length=255, verbose_name='地址')),
                ...
                ('image', models.ImageField(default='img/users_ico/default.png', max_length=255, upload_to='img/users_ico', verbose_name='头像')),
                ('permission', models.JSONField(default=django.db.models.expressions.Value('null'), verbose_name='用户权限')),
                ...
                ('modidate', models.DateTimeField(null=True, verbose_name='修改时间')),
                ('modiuser', models.CharField(max_length=50, null=True, verbose_name='创建人')),
                ('dept_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_dept', to='appUsers.department')),
                ('group_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_group', to='appUsers.usergroup')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('type_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_type', to='appUsers.usertype')),
